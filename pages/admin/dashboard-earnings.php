	...
	<div class="admin-details-wrap">
        ...
        <div class="navigation">
            ...
            <div class="chart-select">
                <div class="category active" onclick="changeData('earnings')">Earned Amount</div>
                <div class="category" onclick="changeData('orders')">Amount of Sales</div>
                <div class="category" onclick="createSourceData('signups')">Amount of Signups</div>
                <div class="category" onclick="changeData('users')">Daily Active Users</div>
                <div class="category" onclick="changeData('captcha')">Captcha Requests</div>
            </div>
        </div>
