<main class="content">
	...
	<div class="section-5">
		...
		<div class="cards">
			<?php 
				foreach([
					['name' => '5$ Balance', 'icon' => 'rubin.svg', 'price' => '5', 'desc' => 'Credit Balance to use all around the shop'],
					['name' => '50$ Balance', 'icon' => 'gold-rubin.svg', 'price' => '50', 'desc' => 'Credit Balance to use all around the shop'],
					['name' => '20$ Balance', 'icon' => 'rubin.svg', 'price' => '20', 'desc' => 'Credit Balance to use all around the shop'],
				] as $prod) { ?>
					<div class="prod-card">
						<h5><?= $prod['name'] ?></h5>
